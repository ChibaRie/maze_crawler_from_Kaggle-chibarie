...
│       └── plans/           # 实现计划
├── examples/
│   └── crawl-starter-scouts-miners-smarter-bfs.ipynb  # 参考：1000+ 分范例
├── README.md               # 竞赛规则速查
...
提交后得分 554，通过对战随机 Agent 达到 80% 胜率（4/5 种子）。分析失败场景发现：
...
### v2：学习强者，精准改进（目标 1000+）

下载了一个 1000+ 分的公开方案 ([crawl-starter-scouts-miners-smarter-bfs](examples/crawl-starter-scouts-miners-smarter-bfs.ipynb))，逐行分析后提炼出 **7 项关键差异**：
